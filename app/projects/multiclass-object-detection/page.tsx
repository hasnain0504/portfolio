        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="/static/images/tinyimagenet/train_val_accuracy_resnet50.png"
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="/static/images/tinyimagenet/train_val_loss_resnet50.png"
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="/static/images/tinyimagenet/model_accuracy_comparison.png"
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="/static/images/tinyimagenet/fewshot_protonet_vs_maml.png"
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="/static/images/tinyimagenet/maml_meta_accuracy.png"
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="/static/images/tinyimagenet/tsne_embeddings.png"
