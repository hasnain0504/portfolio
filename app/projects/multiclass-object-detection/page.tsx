        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="public/static/images/train_val_accuracy_resnet50.png"
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="public/static/images/train_val_loss_resnet50.png"
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="public/static/images/model_accuracy_comparison.png"
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="public/static/images/fewshot_protonet_vs_maml.png"
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="public/static/images/maml_meta_accuracy.png"
          ...
          <div>
            ...
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
              <img
                src="public/static/images/tsne_embeddings.png"
